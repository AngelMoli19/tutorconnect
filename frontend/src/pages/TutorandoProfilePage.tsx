...
export function TutorandoProfilePage() {
  const [data, setData] = useState<TutorandoProfileResponse | null>(null);
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          borderTop: "4px solid var(--role-tutorando-500)",
          borderRadius: "50%",
  ...
  const { tutorando, assigned_tutor, assignments_count } = data;
  const profile = tutorando.profile;
  const fullName = `${profile.first_name} ${profile.last_name_father} ${profile.last_name_mother}`.trim();
  const initials = `${profile.first_name?.[0] || ''}${profile.last_name_father?.[0] || ''}`.toUpperCase();
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        position: "relative",
        overflow: "hidden",
        boxShadow: "0 10px 40px -10px rgba(44, 95, 141, 0.3)"
      }}>
        {/* Decorative circles */}
        <div style={{
          position: "absolute",
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {assigned_tutor
              ? `${assigned_tutor.profile.first_name} ${assigned_tutor.profile.last_name_father}`
              : "Sin asignar"}
          </div>
          {assigned_tutor && (
            <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            height: "100px",
            borderRadius: "50%",
            background: "linear-gradient(135deg, rgba(44, 95, 141, 0.1), rgba(44, 95, 141, 0.05))",
            filter: "blur(20px)"
          }} />
          <div style={{
            width: "56px",
            ...
            color: "white",
            marginBottom: "1rem",
            boxShadow: "0 8px 16px rgba(44, 95, 141, 0.2)"
          }}>
            <svg width="28" height="28" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            justifyContent: "center",
            color: "white",
            boxShadow: "0 4px 12px rgba(44, 95, 141, 0.2)"
          }}>
        ...
        <div style={{
          ...
          />
          <InfoRow
            icon={<svg width="18" height="18" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" /></svg>}
            label="Código de matrícula"
            value={tutorando.enrollment_code ?? "-"}
          />
          <InfoRow
        ...
        <div style={{
          ...
          <div style={{
            ...
            <InfoRow
              icon={<svg width="18" height="18" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" /></svg>}
              label="Nombre"
              value={`${assigned_tutor.profile.first_name} ${assigned_tutor.profile.last_name_father} ${assigned_tutor.profile.last_name_mother}`}
            />
            <InfoRow
              icon={<svg width="18" height="18" viewBox="0 0 20 20" fill="currentColor"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" /><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" /></svg>}
              label="Correo"
              value={assigned_tutor.profile.email}
            />
            <InfoRow
              icon={<svg width="18" height="18" viewBox="0 0 20 20" fill="currentColor"><path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" /></svg>}
              label="Teléfono"
              value={assigned_tutor.profile.phone}
            />
          </div>
        </div>
      )}
  ...
  return (
    ...
    >
      <div style={{
        ...
        {icon && <span style={{ color: "var(--role-tutorando-500)" }}>{icon}</span>}
        {label}
      </div>
      <div style={{
        fontWeight: 600,
